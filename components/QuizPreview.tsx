                            ...
                            <div className="mt-8 border-t border-dashed border-zinc-200 dark:border-zinc-800/50 pt-8 pb-4">
                                {!mindMapImage && !isGeneratingImage && (
                                    <div className="relative group">
                                        ...
                                        >
                                            ...
                                            <span className="tracking-widest text-base drop-shadow-sm z-10">生成思维导图卡片</span>
                                        </button>
                                    </div>
                                )}
                                ...
                                {isGeneratingImage && (
                                    <div className="w-full py-8 flex flex-col items-center justify-center gap-4 bg-zinc-50/50 dark:bg-white/5 rounded-2xl border border-zinc-100 dark:border-white/5 backdrop-blur-sm">
                                        ...
                                        <span className="text-xs font-medium tracking-widest text-zinc-500 dark:text-zinc-300 animate-pulse">正在绘制思维导图...</span>
                                    </div>
                                )}
                                    ...
                                    <div className="space-y-4 animate-fade-in">
                                        ...
                                        >
                                            ...
                                            <div className="absolute inset-0 bg-black/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                                                <span className="bg-black/50 backdrop-blur-md text-white px-3 py-1 rounded-full text-xs">点击放大</span>
                                            </div>
                                        </div>
